...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Nilai Page</h1>
    <?php
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= $url ?>/app/nilai_semester/nilai_semester_periode.php?id_periode=<?= $row["id_periode"] ?>" class="btn btn-info btn-sm ">
