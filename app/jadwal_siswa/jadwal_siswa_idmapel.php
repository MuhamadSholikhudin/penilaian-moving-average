...
$mpl = QueryOnedata("SELECT * FROM mapel WHERE id_mapel = ".$_GET['id_mapel']."")->fetch_assoc();
?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <a href="<?= $url ?>/app/jadwal_siswa/jadwal_siswa_mapel.php" class="btn btn-info btn-sm btn-circle">
        ...
        <div class="card-body table-responsive">
            <table id="example" class="display table" style="width:100%">
                ...
                <tbody>
                    <?php
                    foreach (QueryManyData("SELECT * FROM jadwal_siswa WHERE id_mapel = ".$_GET['id_mapel']."") as $row) {
