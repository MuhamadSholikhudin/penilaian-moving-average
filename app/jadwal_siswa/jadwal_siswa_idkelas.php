...
$kls = QueryOnedata("SELECT * FROM kelas WHERE id_kelas = ".$_GET['id_kelas']."")->fetch_assoc();
?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <a href="<?= $url ?>/app/jadwal_siswa/jadwal_siswa_kelas.php" class="btn btn-info btn-sm btn-circle">
        ...
        <div class="card-body">
            <table id="example" class="display" style="width:100%">
                ...
                <tbody>
                    <?php
                    foreach (QueryManyData("SELECT * FROM jadwal_siswa WHERE id_kelas = ".$_GET['id_kelas']."") as $row) {
