            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="background: url('<?= $url.'/assets/img/' ?>dfdskj-context-digram.jpg');"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    ?>
                                    <form class="user" action="<?= $url . "/app/aksi/login.php" ?>" enctype="multipart/form-data" method="POST">
