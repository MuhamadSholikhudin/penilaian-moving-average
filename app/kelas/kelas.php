    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <a href="<?= $url ?>/app/kelas/kelas_tambah.php" class="btn btn-info btn-sm btn-circle">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $row["kelas"] ?></td>  
                            <td>
                                <a href="<?= $url ?>/app/kelas/kelas_edit.php?id_kelas=<?= $row["id_kelas"] ?>" class="btn btn-warning btn-sm btn-circle">
