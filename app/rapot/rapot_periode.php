...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Page Rapot </h1>
    <?php
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $row["nm_kelas"] ?></td>
                            <td>
                                <a href="<?= $url ?>/app/rapot/rapot_periode_kelas.php?id_periode=<?= $_GET["id_periode"] ?>&id_kelas=<?= $row["id_kelas"] ?>" class="btn btn-info btn-sm ">
