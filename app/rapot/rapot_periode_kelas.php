...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Data Rapot periode <?= $periode['nm_periode'] ?> kelas <?= $kelas['kelas'] ?> <?= $kelas['nm_kelas'] ?></h1>
    <?php
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                Data Rapot <?= $periode['nm_periode'] ?> kelas <?= $kelas['kelas'] ?> <?= $kelas['nm_kelas'] ?>
            </h6>
        </div>
        <div class="card-body">
