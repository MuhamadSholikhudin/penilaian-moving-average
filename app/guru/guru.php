    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <a href="<?= $url ?>/app/guru/guru_tambah.php" class="btn btn-info btn-sm btn-circle">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= $url ?>/app/guru/guru_edit.php?id_guru=<?= $row["id_guru"] ?>" class="btn btn-warning btn-sm btn-circle">
