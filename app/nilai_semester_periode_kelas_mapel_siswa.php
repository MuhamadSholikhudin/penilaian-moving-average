                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $row["nm_siswa"] ?></td>
                            <td>
                                <a href="<?= $url ?>/app/nilai_semester_periode_kelas_mapel.php?id_periode=<?= $_GET["id_periode"] ?>&id_kelas=<?= $_GET["id_kelas"] ?>&id_mapel=<?= $_GET["id_mapel"] ?>" class="btn btn-info btn-sm ">
